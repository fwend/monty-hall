...
console.log("Mont Hall without switch, expected value ~0.333: ", montyHallWithoutSwitch(1000))
console.log("Monty Hall with switch, expected value ~0.666: ", montyHallWithSwitch(1000))
